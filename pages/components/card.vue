						...
						<div class="card-content">
							<div class="card-body">
								...
								<p class="card-text">
									...
									biscuit apple pie jelly-o sweet roll. Toffee
									sugar plum sugar plum jelly-o jujubes bonbon
									dessert carrot cake.
								</p>
							</div>
							<img
								...
								<div class="accordion" id="cardAccordion">
									<div class="card">
										<div
											...
											role="button">
											<span
												class="collapsed collapse-title"
										...
										<div
											...
											<div class="card-body">
												Cheesecake muffin cupcake dragée
												lemon drops tiramisu cake
												gummies chocolate cake.
												Marshmallow tart croissant. Tart
												dessert tiramisu marzipan
									...
									<div class="card collapse-header">
										...
										<div
											...
											data-parent="#cardAccordion">
											<div class="card-body">
												Pastry pudding cookie toffee
												bonbon jujubes jujubes powder
												topping. Jelly beans gummi bears
												sweet roll bonbon muffin
									...
									<div class="card open">
										...
										<div
											...
											data-parent="#cardAccordion">
											<div class="card-body">
												Sweet pie candy jelly. Sesame
												snaps biscuit sugar plum. Sweet
												roll topping fruitcake. Caramels
												liquorice biscuit ice cream
					...
					<div class="card">
						<div class="card-content">
							...
							<div class="card-body">
								...
								<p class="card-text">
									Chocolate sesame snaps apple pie danish
									cupcake sweet roll jujubes tiramisu.Gummies
									bonbon apple pie fruitcake icing biscuit
						...
						<div class="card-content">
							...
							<div class="card-body">
								<p class="card-text">
									...
									marzipan jujubes. Jelly-o sesame snaps
									cheesecake topping. Cupcake fruitcake
									macaroon donut pastry gummies tiramisu
						...
						<div class="card-content">
							...
							<div class="card-body">
								<p class="card-text">
									...
									adipisicing elit. Sunt assumenda mollitia
									officia dolorum eius quasi.Chocolate sesame
									snaps apple pie danish cupcake sweet roll
									jujubes tiramisu.
								</p>
								<p class="card-text">
									Gummies bonbon apple pie fruitcake icing
									biscuit apple pie jelly-o sweet roll. Toffee
									sugar plum sugar plum jelly-o jujubes bonbon
									dessert carrot cake. Sweet pie candy jelly.
									Sesame snaps biscuit sugar plum. Sweet roll
									topping fruitcake. Caramels liquorice
									biscuit ice cream fruitcake cotton candy
									tart.
								</p>
							</div>
						</div>
						...
						<div class="card-content">
							<div class="card-body">
								...
								<form class="form" method="post">
									...
									<div
										class="form-actions d-flex justify-content-end">
										<button
											type="submit"
					...
					<div class="card">
						<div class="card-content">
							...
							<div class="card-body">
								...
								<p class="card-text">
									Jelly-o sesame snaps cheesecake topping.
									Cupcake fruitcake macaroon donut pastry
									gummies tiramisu chocolate bar muffin.
									Dessert bonbon caramels brownie chocolate
									bar chocolate tart dragée.
								</p>
								<p class="card-text">
									Cupcake fruitcake macaroon donut pastry
									gummies tiramisu chocolate bar muffin.
