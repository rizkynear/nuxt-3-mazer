						...
						<div class="card-content">
							<div class="card-body">
								<p>
									...
									<code>.dropdown-toggle-split</code> with
									your dropdown toggle class And to add
									divider between dropdown item use class
						...
						<div class="card-content">
							<div class="card-body">
								<p>
									...
									<code>.dropdown-item</code> for font-size
									and spacing of emojis.
								</p>
								<div class="btn-group mb-1">
									<div class="dropdown">
										<button
											...
											aria-expanded="false">
											<i
												class="bi bi-error-circle me-50"></i>
											Icon Left
										</button>
										<div
											class="dropdown-menu"
											...
											<a class="dropdown-item" href="#"
												><i
													class="bi bi-bell me-50"></i>
												Option 2</a
											>
											<a class="dropdown-item" href="#"
												><i
													class="bi bi-time me-50"></i>
												Option 3</a
											>
										</div>
									</div>
								...
								<div class="btn-group mb-1">
									<div class="dropdown icon-right">
										<button
											...
											Icon Right
											<i
												class="bi bi-error-circle ml-50"></i>
										</button>
										<div
											class="dropdown-menu"
											...
											<a
												...
												>Option 1
												<i
													class="bi bi-bar-chart-alt-2 ml-50"></i
											></a>
											<a
												class="dropdown-item justify-content-between"
												href="#"
												>Option 2
												<i class="bi bi-bell ml-50"></i
											></a>
											<a
												class="dropdown-item justify-content-between"
												href="#"
												>Option 3
												<i class="bi bi-time ml-50"></i
											></a>
										</div>
									</div>
								</div>
						...
						<div class="card-content">
							<div class="card-body">
								<p>
									...
									<code>.dropdown-menu</code> to right align
									the dropdown menu. Trigger dropdown menus at
									the up / right / left of the elements by
									adding
									<code
						...
						<div class="card-content">
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div
											class="btn-group dropdown me-1 mb-1">
											<button
												type="button"
						...
						<div class="card-content">
							<div class="card-body">
								<p>
									...
									<code>data-reference</code> attributes to
						...
						<div class="card-content">
							<div class="card-body">
								<p>
									...
									<code>.dropdown-header</code> for the header
									of groups and for sepration of group you can
									use <code>.dropdown-divider</code>.
								</p>
								<p>
