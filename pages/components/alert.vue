			...
			<div class="row">
				<div class="col-12 col-md-6">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="alert alert-primary">
								<i class="bi bi-star"></i> This is primary
								alert.
							</div>
							<div class="alert alert-success">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="alert alert-light-danger color-danger">
								<i class="bi bi-exclamation-circle"></i> This is
								danger alert.
							</div>
							<div
								class="alert alert-light-secondary color-secondary">
								<i class="bi bi-star"></i> This is secondary
								alert.
							</div>
				...
				<div class="col-12 col-md-6">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div
								class="alert alert-info alert-dismissible show fade">
							...
							<div
								class="alert alert-light alert-dismissible show fade">
							...
							<div
								class="alert alert-dark alert-dismissible show fade">
